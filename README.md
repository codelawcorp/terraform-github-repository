...
| <a name="output_github_actions_permissions"></a> [github\_actions\_permissions](#output\_github\_actions\_permissions) | GitHub Actions permissions configuration |
